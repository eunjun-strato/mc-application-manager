...
('JupyterLab for Object Storage', 'JupyterLab data analysis environment connected to Object Storage registered in Tumblebug.', 'Analyze Object Storage data in JupyterLab', 'Object Storage', 'https://raw.githubusercontent.com/jupyter/design/master/logos/Square%20Logo/squarelogo-greytext-orangebody-greymoons/squarelogo-greytext-orangebody-greymoons.png', 'https://raw.githubusercontent.com/jupyter/design/master/logos/Square%20Logo/squarelogo-greytext-orangebody-greymoons/squarelogo-greytext-orangebody-greymoons.png', 1, 2, 2, 4, 5, 10, 80.0, 80.0, 1, 1, false, 8888, false, NULL, NULL, NULL, false, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(11, 'DOCKER', 'quay.io/jupyter/scipy-notebook', '2026-07-28', 'https://quay.io/repository/jupyter/scipy-notebook', NULL, 'Jupyter Docker Stacks', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'JupyterLab scientific Python environment for Object Storage analysis', 'official', 'amd64,arm64', 'Object Storage', false, false, true, CURRENT_TIMESTAMP, 'linux', NULL, NULL);
...
-- JupyterLab for Object Storage
INSERT INTO SOFTWARE_CATALOG_REF(CATALOG_ID, REF_IDX, REF_VALUE, REF_DESC, REF_TYPE) VALUES
(11, 0, 'https://jupyter-docker-stacks.readthedocs.io/', '', 'HOMEPAGE'),
(11, 1, 'object-storage', '', 'CAPABILITY'),
(11, 2, 's3-compatible', '', 'TAG'),
(11, 3, 'jupyterlab', '', 'TAG'),
(11, 4, 'vm_application_install', '', 'workflow'),
(11, 5, 'vm_application_uninstall', '', 'workflow');
